...
if ($is_production) {
    add_action('init', function () use($theme_version, $theme_uri) {
        wp_register_script('niRvana', $theme_uri . '/assets/minify/app.min.js', array('jquery'), $theme_version);
        wp_register_style('niRvana', $theme_uri . '/assets/minify/app.min.css', array(), $theme_version);
